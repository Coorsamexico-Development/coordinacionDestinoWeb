...
<template>
    <AppLayout title="Productos">
        <template #header>
            ...
            >
                <h2
                    class="mr-4 text-xl font-semibold leading-tight text-gray-800"
                    style="font-family: &quot;Montserrat&quot;"
                >
                    Productos
                </h2>
                <div class="mr-2">
                    <button
                        class="bg-[#44BFFC] px-8 py-2 rounded-2xl flex flex-row"
                    >
                        <img
                            class="w-4 mr-2"
                        ...
                        />
                        <a
                            :href="route('donwloadExportExample')"
                            class="text-white"
                        >
                            Descargar ejemplo
                        </a>
        ...
        <div
            class="py-4 m-8 bg-white rounded-2xl"
            style="font-family: &quot;Montserrat&quot;"
        >
            <table class="w-full">
                ...
                <tbody>
                    ...
                    -->
                        ...
                        <td class="text-center">
                            <button
                                @click="opennModalViaje(producto)"
