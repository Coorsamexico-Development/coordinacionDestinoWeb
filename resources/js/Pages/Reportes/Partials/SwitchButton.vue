...
<template>
    <div class="flex flex-row justify-start py-4 overflow-x-auto">
        <div
        ...
        >
            <div @click="setearPlataforma(plataforma.id)">
                <div
                    class="bg-[#C6C6C6] px-4 py-1 rounded-full text-white flex flex-row"
                    v-if="activo === plataforma.id"
                >
                    <h1 class="mr-4" style="font-family: Montserrat">
                        {{ plataforma.nombre }}
                    </h1>
                    <ContadorPlataforma
                        :confirmaciones="plataforma.confirmaciones_dts"
                        :ubicacion="ubicacion"
                        :statusId="statusId"
                    />
                </div>
