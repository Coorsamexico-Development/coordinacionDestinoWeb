        ...
        await axios
            ...
            .then((response) => {
                ...
                if (response.data.valors.length > 0) {
                    for (
                        let index = 0;
                        index < response.data.campos.length;
                        index++
                    ) {
                        ...
                        for (
                            let index2 = 0;
                            index2 < response.data.valors.length;
                            index2++
                        ) {
                        ...
                        for (
                            let index3 = 0;
                            index3 < response.data.evidencias.length;
                            index3++
                        ) {
                            const evidencia = response.data.evidencias[index3];
                            if (evidencia.campo_id == campo.campo_id) {
                                campoWithValors.evidencias.push(evidencia);
                            }
                        }
...
const cambio = (id) => {
    axios
        .get(route("changeToRiesgo"), { params: { id: id } })
        .then((response) => {
            console.log(response.data);
        })
        .catch((err) => {
...
watch(cita, (newCita) => {
    ...
    try {
        axios
            .get(route("changeCita", { fecha: newFecha, viaje: props.dt.id }))
            .then((response) => {
                //console.log(response.data)
    ...
    >
        ...
        <template #content>
            <div class="my-3" id="cambio-de-cita">
                <h1 class="mx-2 font-semibold" style="font-size: 1rem">
                    Cita:
                </h1>
                ...
                <div id="valores-by-status" class="my-4">
                    ...
                    >
                        <div class="snap-center">
                            <div
                                v-if="
                                    statusActual.status_id !== 10 ||
                                    statusActual.status_id !== 11
                                "
                            >
                        ...
                        <div
                            ...
                            "
                        >
                            <h1 class="mt-4 text-lg font-semibold text-center">
                                No hay información en este paso
                            </h1>
                        </div>
                        <div
                            class="mt-8 snap-center"
                            v-if="statusActual.status_id"
                        >
                            <div v-if="pdf !== null">
                                <div class="mx-4 my-6">
                                    <h1
                                ...
                                <div class="grid grid-rows-3 mx-2 my-6">
                                    <div class="w-full row-start-1 px-2">
                                        ...
                                        >
                                            ...
                                            <button
                                                class="bg-[#44BFFC] text-white px-2 py-2 rounded-lg m-2 flex flex-row justify-between"
                                                @click="agregarCorreo()"
                                            >
                                                <svg
                                                    class="mx-1"
                                        ...
                                        <div class="grid grid-cols-2 mt-2">
                                            <div
                                                class="flex flex-row py-1 mx-1 my-1 bg-blue-200 rounded-2xl"
                                            ...
                                            >
                                                <button
                                                    @click="
                                                        eliminarEmail(email)
                                                    "
                                                    class="px-1 mx-1 bg-red-500 rounded-full"
                                                >
                                                    <svg
                                                        width="20px"
                                                        height="20px"
                                    ...
                                    <div
                                        class="row-start-3 my-2"
                                        v-if="emails.length > 0"
                                    >
                                        <button
                                            class="bg-[#4f595e] text-white px-2 py-2 rounded-lg flex flex-row items-center"
                                            @click="enviarCorreo"
                                        >
                                            <svg
                                                class="mx-2"
