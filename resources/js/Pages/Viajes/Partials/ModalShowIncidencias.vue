        ...
        <template #content>
            <table class="w-full" style="font-family: Montserrat">
                <thead class="border-b-2">
                    <tr>
                        ...
                        <td class="text-center font-semibold pb-2">
                            Tipo de incidencia
                        </td>
                ...
                <tbody>
                    <tr v-for="incidencia in incidencias" :key="incidencia.id">
                        <td class="text-center text-sm py-2 px-4">
                            <button
                                class="bg-[#E86881] px-2 py-1 rounded-full"
                                @click="borrarIncidencia(incidencia.id)"
                                v-if="
                    ...
                    <tr
                        class="border-t-2"
                        v-for="(newIncidencia, key) in newIncidencias"
                        :key="key"
                    >
                        ...
                        <td class="text-center py-2">
                            ...
                            >
                                <option
                                    v-for="tipo_incidencia in tipos_incidencias"
            ...
            <div class="flex justify-center mt-4">
                <button
                    ...
                    class="p-2 px-4 border-2 rounded-full"
                >
